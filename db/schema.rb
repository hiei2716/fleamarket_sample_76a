...
ActiveRecord::Schema.define(version: 2020_06_10_033405) do
  ...
  create_table "credit_credit_cards", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.string "customer_id", null: false
    t.string "credit_card_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_credit_credit_cards_on_user_id"
  end
